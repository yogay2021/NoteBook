## 调整xml所在的文件夹路径即可，输出的json路径需要添加json的文件名，只有路径不够
...
if __name__ == '__main__':
    ...
    # 通过文件夹生成
    ann_path = 'E:/Project/Python/smartcar/datasets/copy_paste/DatasetVocSASU_ForIcarM2023/Annotations'
    json_save_path = 'E:/Project/Python/smartcar/datasets/copy_paste/DatasetVocSASU_ForIcarM2023/json_labels/trainval.json'
