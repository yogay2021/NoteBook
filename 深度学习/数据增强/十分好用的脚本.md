> 用于VOC数据集的数据增强，能够实现labels的校正。
>
> 接口是输入图像，labels文件 夹   输出图像，labels文件夹
...
if __name__ == "__main__":
    ...
    IMG_DIR = "E:/Project/Python/smartcar/datasets/mydataset/train augmen/img/"                  ### 原始数据集图像的路径
    XML_DIR = "E:/Project/Python/smartcar/datasets/mydataset/train augmen/labels/"              ### 原始xml文件的路径

# =============================================================================
#     AUG_XML_DIR = "./Annotations"  # 存储增强后的XML文件夹路径
# =============================================================================
    AUG_XML_DIR = "E:/Project/Python/smartcar/datasets/mydataset/train augmen/afteraug/labels/"              ### 数据增强后的xml文件的保存路径
    try:
...
# =============================================================================
    AUG_IMG_DIR = "E:/Project/Python/smartcar/datasets/mydataset/train augmen/afteraug/img/"  ### 数据增强后图片的保存路径
    try:
